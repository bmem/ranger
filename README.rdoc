...
* Participants (information about a Person's activity in an Event)
  * The Person's callsign and wallet name at the time of the Event
  * Their participation status in the Event (planned, confirmed, withdrawn...)
...
* Slots (Thursday grave dirt rangers, Saturday afternoon shift leads, ...)
  ...
  * Participants sign up for these
* Work Logs
  * Actual sign in and sign out times for Participants
* Users
